    ...
    render() {
        return (
            <div>
                ...
                <p>The Internet is a network of independent computers andother hardware devices connected 
                ...
                <p>Let's say you are wirelessly connected to the internet at your house. After typing the URL into the browser, 
                    ...
                    data like emails, webpages, or files on the internet. Once you initiate your request TCP IP protocols take your 
                ...
                <p>The hardware for this works as follows: After you request a web page, TCP IP sends your request wirelessly using 
                    ...
                    one server to another until it reaches the server that's hosting the website you wanted. Then, the webpage you requested 
                    is returned in just the same way. If this all happens correctly, the packets of data arrive, are reassembled, and
                    the web browser shows you a perfect copy of the webpage.</p>
                ...
                <p>When we do a Google search we may only consider this an exchange between ourselves 
                    ...
                    with a laptop. Let's say the coffee shop has an open WiFi, and other people in the coffee shop
                    are also using the internet. Let's think of all the sites everyone in the coffee
                    shop is visiting as sharing a single, centralized data center. You do a google search 
                ...
                <p>Additionally, there are a lot of hops the search may take for a full round trip. While most 
                    of those nodes are secure, if an attacker gains access to one, they could expose web traffic. 
